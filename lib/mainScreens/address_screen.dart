...
import 'package:client/mainScreens/save_address_screen.dart';
import 'package:client/models/address.dart';
import 'package:client/widgets/address_design.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        label: const Text(" Enregistrer une nouvelle adresse"),
